...
describe('TEST TASK 10.JS FUNCTIONS *CASE: USER ADDS £2 CREDIT AND 2 COLORS MATCH)', () => {
...
expect(credit).toBe('£2 in your Wallet')
...
//EXPECT RESULT TO BE:
expect(result.innerHTML).toBe("You have withdrawn <span class=\"lead text-danger gameBalance\">£3.50</span> from your total game balance , You have: <p id=\"wallet\" class=\"lead text-danger\">£5.5 in your wallet</p>")
